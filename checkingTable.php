...
$query = "SELECT json FROM tables where id='$id'";
    ...
    <div class="wrap">
        <div class="tableDiv">
            <table style="border: none; margin-left: 50px;">
                <tbody>
                <?php
                $answer = $solv->ReturnHorArr($row[0]);
                $answer2 = $solv->ReturnVerArr($row[0]);
        ...
        <form action="./checkingTable.php">
            <input type="submit" class="input" name="data" value="<?= $row[0]?>" class="checkButton" >Проверить</input>
        </form>
